...
const defaultMethods = [
  {
    ...
    icon: "mail",
    title: "Email",
    value: "hello@atelierco.com",
    description: "For proposals, partnerships, and detailed project notes.",
    actionLabel: "Send email",
    href: "mailto:hello@atelierco.com",
  },
  {
    id: "phone",
    icon: "phone",
    title: "Call",
    value: "+1 (555) 014-9082",
    description: "Speak with our client desk Monday through Friday.",
    actionLabel: "Call now",
    href: "tel:+15550149082",
  },
  {
    id: "chat",
    icon: "chat",
    title: "Live chat",
    value: "Average reply: 4 min",
    description: "Best for quick questions, support, and active accounts.",
...
const defaultLocations = [
  ...
  },
  {
    ...
    city: "New York",
    label: "Client Lounge",
    address: "88 Spring Street, New York, NY",
    hours: "By appointment",
    image:
      "https://images.unsplash.com/photo-1494526585095-c41746248156?auto=format&fit=crop&w=900&q=84",
  },
];
...
const defaultFields = [
  ...
  },
  {
    ...
    required: false,
    options: ["Under $5k", "$5k-$20k", "$20k-$75k", "$75k+"],
  },
  {
    id: "message",
    label: "Message",
...
export const universalContactPageV1DefaultProps = {
  ...
  hero: {
    ...
    subtitle:
      "A premium, adaptable contact page for sales, support, partnerships, bookings, and local inquiries.",
    body: "Give visitors every practical path to reach you while keeping the page polished, calm, and conversion-ready.",
    image:
      "https://images.unsplash.com/photo-1556761175-4b46a572b786?auto=format&fit=crop&w=1600&q=84",
  ...
  map: {
    ...
    fallbackImage:
      "https://images.unsplash.com/photo-1524661135-423995f22d0b?auto=format&fit=crop&w=1600&q=84",
  },
  support: {
    enabled: true,
    title: "Common paths",
    items: [
      {
        id: "sales",
        title: "Sales inquiry",
        text: "For pricing, proposals, and implementation planning.",
        drawerTitle: "Sales inquiry details",
        drawerBody:
          "Route high-intent buyers to your sales process, qualification questions, booking links, or account team.",
      },
      {
        id: "support",
        title: "Customer support",
        text: "For active projects, billing, and product help.",
        drawerTitle: "Support request details",
        drawerBody:
          "Use this drawer for support hours, priority channels, helpdesk links, and escalation details.",
      },
      {
        id: "partners",
        title: "Partnerships",
        text: "For collaborations, suppliers, and media requests.",
        drawerTitle: "Partnership details",
        drawerBody:
          "Describe what partnership requests you accept and what information your team needs up front.",
      },
    ],
  },
  footerCta: {
    ...
    subtitle:
      "Add your booking link, calendar workflow, or concierge intake path.",
...
const UniversalContactPageV1 = (incomingProps) => {
  ...
  const config = useMemo(
    () => deepMerge(universalContactPageV1DefaultProps, props),
    [props],
  );
  const {
    global,
  ...
  return (
    ...
    >
      <section style={{ padding: global.sectionPadding }}>
        <div
          className="mx-auto grid items-center gap-10 lg:grid-cols-[0.95fr_1.05fr]"
          style={{ maxWidth: global.maxWidth }}
        >
          <div>
            <p
              className="mb-4 text-xs font-black uppercase tracking-[0.28em]"
              style={{ color: global.accentColor }}
            >
              {hero.eyebrow}
            </p>
            <h1
              className="m-0 text-4xl font-black leading-tight tracking-tight md:text-6xl"
            ...
            <p
              ...
              style={{ color: global.mutedColor }}
            >
              {hero.subtitle}
            </p>
            <p className="mt-4 leading-7" style={{ color: global.mutedColor }}>
              {hero.body}
            </p>
          </div>
          <img
            ...
            style={{ borderRadius: global.radius, boxShadow: global.shadow }}
          />
        </div>
      </section>
      ...
      <section className="px-6 pb-20">
        <div
          className="mx-auto grid gap-6 lg:grid-cols-[0.9fr_1.1fr]"
          style={{ maxWidth: global.maxWidth }}
        >
            ...
            {toArray(contactMethods).map((method) => {
              ...
              return (
                <a
                  key={method.id}
                  href={method.href || "#"}
                  onClick={(event) => builderLocked && event.preventDefault()}
                  className="group block border p-5 no-underline transition-transform hover:-translate-y-1"
                  style={{
          ...
          <form
            action={form.actionUrl || undefined}
            method={form.method}
            onSubmit={submitForm}
          ...
          >
            ...
            <p className="mt-2 leading-7" style={{ color: global.mutedColor }}>
              {form.subtitle}
            </p>
            ...
            <button
              className="mt-5 inline-flex items-center gap-2 rounded-full px-6 py-3 text-sm font-black text-white"
            ...
            {submitted ? (
              <div
                ...
                style={{
                  borderColor: global.successColor,
                  color: global.successColor,
                }}
              >
                <strong>{form.successTitle}</strong>
                <p className="mt-1 text-sm">{form.successText}</p>
              </div>
            ) : null}
          </form>
        </div>
          ...
          {toArray(locations).map((location) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p
                  className="mt-3 flex gap-2 leading-6"
                  style={{ color: global.mutedColor }}
                >
                  <MapPin size={18} /> {location.address}
                </p>
                <p
                  className="mt-2 flex gap-2 leading-6"
                  style={{ color: global.mutedColor }}
                >
      ...
      {map.enabled ? (
        <section className="px-6 pb-20">
          ...
          >
            <div className="p-6">
              <h2 className="text-3xl font-black">{map.title}</h2>
            </div>
            {map.embedUrl ? (
              <iframe
                title={map.title}
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {toArray(support.items).map((item) => (
                <button
                  ...
                  onClick={() => !builderLocked && setActiveDrawer(item)}
                  style={{
                    backgroundColor: global.surfaceColor,
                    borderColor: global.borderColor,
                    borderRadius: global.radius,
      ...
      {footerCta.enabled ? (
        <section className="px-6 pb-20">
          <div
            className="mx-auto border p-8 text-center"
            style={{
              maxWidth: global.maxWidth,
              backgroundColor: global.surfaceColor,
              borderColor: global.borderColor,
          ...
          >
            ...
            <p
              className="mx-auto mt-3 max-w-2xl leading-7"
              style={{ color: global.mutedColor }}
            >
              {footerCta.subtitle}
            </p>
            <a
              ...
              onClick={(event) => builderLocked && event.preventDefault()}
              className="mt-6 inline-flex rounded-full px-6 py-3 text-sm font-black text-white no-underline"
              style={{ backgroundColor: global.primaryColor }}
            >
...
const FormField = ({ field, global }) => {
  ...
  return (
    <label className={field.type === "textarea" ? "md:col-span-2" : ""}>
      <span
        className="mb-1 block text-xs font-black uppercase tracking-[0.16em]"
        style={{ color: global.mutedColor }}
      >
        {field.label}
        {field.required ? " *" : ""}
      ...
      {field.type === "textarea" ? (
        ...
        >
          ...
          {toArray(field.options).map((option) => (
...
const SupportDrawer = ({ item, global, close }) => (
  <div className="fixed inset-0 z-50 bg-black/45">
    <aside
      className="ml-auto h-full w-full max-w-xl overflow-auto p-6"
      style={{ backgroundColor: global.surfaceColor }}
    >
      <button
        className="mb-6 rounded-full border p-3"
        onClick={close}
        style={{ borderColor: global.borderColor }}
      >
        <X size={18} />
      </button>
      <p
